// From Price, Mark J..Tools and Skills for .NET 8 
// Chapter Containerizing your own .NET applications
...
public class EnvironmentInfo
{
    ...
    public bool InContainer { get; } = Environment
      .GetEnvironmentVariable("DOTNET_RUNNING_IN_CONTAINER") is not null;
}
